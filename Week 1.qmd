...
In this week's diary entry I will start by briefly explaining the basics of remote sensing, to then show two real life examples that use different types of resolutions to solve different environmental and demographic issues. I end the chapter with my final reflection. 
